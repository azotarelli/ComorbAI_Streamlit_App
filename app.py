        ...
        with st.spinner("Analisando..."):
            ...
            if not texto_limpo_input:
                ...
                encoding = tokenizer.encode_plus(
                    ...
                    padding='max_length',
                    return_attention_mask=True, # CORREÇÃO AQUI: de 'attention_attention_mask' para 'attention_mask'
                    return_tensors='pt',
                    truncation=True
                )

                input_ids = encoding['input_ids'].to(device)
                attention_mask = encoding['attention_mask'].to(device) # CORREÇÃO AQUI: de 'attention_attention_mask' para 'attention_mask'
